...
const PRODUCTS = [
  ...
  { id: 'wu-01', category: 'wu', photo: 'images/products/wu-01.jpg', name: '東方菊花茶', m: 45, l: 55,
    ...
    art: { base: '#e8c874', base2: '#f6e4a8' } },
  { id: 'wu-02', category: 'wu', photo: 'images/products/wu-02.jpg', name: '西穀蕎麥茶', m: 30, l: 40,
    desc: '烘焙蕎麥的堅果焦香，樸實無負擔，是山居人家的日常茶湯。',
    art: { base: '#d9a441', base2: '#f0cf85' } },
  { id: 'wu-03', category: 'wu', photo: 'images/products/wu-03.jpg', name: '南非國寶茶', m: 40, l: 50,
    desc: '南非路易波士茶天然回甜，帶著淡淡蜜香與木質尾韻。',
    art: { base: '#c1652f', base2: '#e8965a' } },
  { id: 'wu-04', category: 'wu', photo: 'images/products/wu-04.jpg', name: '北風桂花玄米茶', m: 35, l: 45, recommended: true,
    desc: '炒香玄米搭配桂花，米香與花香交織，冬日暖胃首選。',
    art: { base: '#e0b653', base2: '#f3dca0' } },

  // 調 -----------------------------------------------------------
  { id: 'tiao-01', category: 'tiao', photo: 'images/products/tiao-01.jpg', name: '青山綠水', m: 35, l: 40, recommended: true,
    desc: '春青綠茶與清水的極簡組合，喝的就是那口最原始的山頭氣。',
    art: { base: '#a8b83f', base2: '#d7e08a' } },
  { id: 'tiao-02', category: 'tiao', photo: 'images/products/tiao-02.jpg', name: '春青菊花', m: 45, l: 55,
    desc: '春青茶湯揉入菊花香氣，清爽花香茶飲，尾韻回甘不膩。',
    art: { base: '#e3c96a', base2: '#f5e5ab' } },
  { id: 'tiao-03', category: 'tiao', photo: 'images/products/tiao-03.jpg', name: '蕎麥冬露', m: null, l: 50, recommended: true,
    minSweet: 50,
    desc: '冬青茶湯以蕎麥提香，質地圓潤，僅供大杯，最低半糖品飲最佳風味。',
    art: { base: '#b5762f', base2: '#dba86a' } },
  { id: 'tiao-04', category: 'tiao', photo: 'images/products/tiao-04.jpg', name: '春青冬露', m: null, l: 50,
    minSweet: 50,
    desc: '春青與冬露工法的相遇，層次分明，僅供大杯。',
    art: { base: '#c9a04a', base2: '#e8cf94' } },
  { id: 'tiao-05', category: 'tiao', photo: 'images/products/tiao-05.jpg', name: '菊花冬露', m: null, l: 55, recommended: true,
    minSweet: 50,
    desc: '冬露工法融合菊花清香，溫潤生津，僅供大杯。',
    art: { base: '#d9b95a', base2: '#f0dfa8' } },
  { id: 'tiao-06', category: 'tiao', photo: 'images/products/tiao-06.jpg', name: '多多綠水', m: null, l: 55,
    minSweet: 50,
    desc: '乳酸的酸甜與淡雅的茶香相互融合，彷彿回到了青澀年少的初戀時光。僅供大杯。',
    art: { base: '#e0a95c', base2: '#f2cf9a', cream: '#f7ecd8' } },

  // 料 -----------------------------------------------------------
  { id: 'liao-01', category: 'liao', photo: 'images/products/liao-01.jpg', name: '菜燕春青', m: 40, l: 45, recommended: true,
    desc: '手工菜燕搭配春青茶湯，Q彈涼糕般的口感是女孩們的最愛。',
    art: { base: '#9ab34a', base2: '#cfe08f', bits: '#e8f0c0' } },
  { id: 'liao-02', category: 'liao', photo: 'images/products/liao-02.jpg', name: '菜燕奶茶', m: 55, l: 60, recommended: true,
    desc: '濃郁奶茶裡藏著滑嫩菜燕，一口茶香一口涼糕，雙重享受。',
    art: { base: '#8a5a34', base2: '#c9a06a', bits: '#f0e2c8' } },
  { id: 'liao-03', category: 'liao', photo: 'images/products/liao-03.jpg', name: '杏仁凍春青', m: 40, l: 45,
    desc: '杏仁凍清甜綿密，襯著春青茶香，是夏天最沁涼的甜點級茶飲。',
    art: { base: '#b6c96a', base2: '#e2eda0', bits: '#f5f2e0' } },
  { id: 'liao-04', category: 'liao', photo: 'images/products/liao-04.jpg', name: '青茶婚貴奶茶', m: 55, l: 60,
    desc: '婚貴凍軟糯彈牙，融進醇厚奶茶，口口都是驚喜。',
    art: { base: '#9a6b3f', base2: '#d1a373', bits: '#e8d3a8' } },
  { id: 'liao-05', category: 'liao', photo: 'images/products/liao-05.jpg', name: '琥珀珍珠奶茶', m: 55, l: 60, recommended: true,
    desc: '熬煮兩小時的琥珀珍珠，焦糖香氣濃郁，經典中的經典。',
    art: { base: '#8a5a2f', base2: '#c9925a', boba: '#4a2c15' } },
  { id: 'liao-06', category: 'liao', photo: 'images/products/liao-06.jpg', name: '蕎麥珍珠奶茶', m: 60, l: 65,
    desc: '蕎麥珍珠比一般珍珠更有嚼勁，搭配奶茶香氣層次更豐富。',
    art: { base: '#7a4e2a', base2: '#c08a52', boba: '#3e2412' } },
  { id: 'liao-07', category: 'liao', photo: 'images/products/liao-07.jpg', name: '青茶凍天蟬那堤', m: 65, l: 75,
    desc: '天蟬紅茶那堤加上青茶凍，奶香茶韻與涼糕口感一次滿足。',
    art: { base: '#c9a373', base2: '#ecd9b8', bits: '#8fae4a' } },
  { id: 'liao-08', category: 'liao', photo: 'images/products/liao-08.jpg', name: '琥珀珍珠天蟬那堤', m: 65, l: 75,
    desc: '琥珀珍珠遇上綿密那堤，濃醇奶香裡藏著焦糖珍珠的驚喜。',
    art: { base: '#c9a373', base2: '#ecd9b8', boba: '#4a2c15' } },
  { id: 'liao-09', category: 'liao', photo: 'images/products/liao-09.jpg', name: '蕎麥珍珠夏青那堤', m: 65, l: 75, recommended: true,
  ...
  // 奶 -----------------------------------------------------------
  { id: 'nai-01', category: 'nai', photo: 'images/products/nai-01.jpg', name: '山峰奶茶', m: 45, l: 50,
    desc: '經典奶茶比例，茶香奶香平衡完美，那堤系列可升級燕麥奶。',
    art: { base: '#8a5e36', base2: '#d1ab7c' } },
  { id: 'nai-02', category: 'nai', photo: 'images/products/nai-02.jpg', name: '夏青那堤', m: 50, l: 60, recommended: true,
    desc: '夏青茶氣厚重帶木質香，融入綿密那堤，尾韻悠長。可升級燕麥奶。',
    art: { base: '#c08a4a', base2: '#ecd2a0' } },
  { id: 'nai-03', category: 'nai', photo: 'images/products/nai-03.jpg', name: '蕎麥那堤', m: 50, l: 65, recommended: true,
    desc: '蕎麥焙火香氣搭配滑順那堤，溫潤不刺激。可升級燕麥奶。',
    art: { base: '#a87840', base2: '#e0be90' } },
  { id: 'nai-04', category: 'nai', photo: 'images/products/nai-04.jpg', name: '天蟬那堤', m: 55, l: 65, recommended: true,
    desc: '天蟬紅茶蜜香混著奶香，濃醇滑順，招牌人氣品項。可升級燕麥奶。',
    art: { base: '#a8623f', base2: '#e0a684' } },

  // 果 -----------------------------------------------------------
  { id: 'guo-01', category: 'guo', photo: 'images/products/guo-01.jpg', name: '白甘蔗春青', m: 55, l: 60, recommended: true,
    noZeroSugar: true,
    desc: '現榨白甘蔗清甜自然，融合春青茶香，不提供無糖。',
    art: { base: '#e3cf8a', base2: '#f6ecd0' } },
  { id: 'guo-02', category: 'guo', photo: 'images/products/guo-02.jpg', name: '香檸綠水', m: 55, l: 60,
    noZeroSugar: true,
    desc: '新鮮檸檬片手工壓榨，酸甜清爽解膩，不提供無糖。',
    art: { base: '#c7d95a', base2: '#eaf2a8', bits: '#f5f7d8' } },
  { id: 'guo-03', category: 'guo', photo: 'images/products/guo-03.jpg', name: '柳丁綠水', m: 65, l: 70,
    noZeroSugar: true,
    desc: '新鮮柳丁果肉滿滿，酸甜果香四溢，不提供無糖。',
    art: { base: '#e0973f', base2: '#f5c98a', bits: '#f9dfae' } },
  { id: 'guo-04', category: 'guo', photo: 'images/products/guo-04.jpg', name: '紅柚綠水', m: 65, l: 70, recommended: true,
    noZeroSugar: true,
    desc: '紅柚果肉清香微苦回甘，搭配綠水更顯清爽，不提供無糖。',
    art: { base: '#e0637a', base2: '#f3a8b8', bits: '#f9cdd8' } },
  { id: 'guo-05', category: 'guo', photo: 'images/products/guo-05.jpg', name: '橘子春青', m: 65, l: 70, recommended: true,
    noZeroSugar: true,
    desc: '橘子鮮果香氣奔放，酸甜比例恰到好處，不提供無糖。',
    art: { base: '#e88b30', base2: '#f7c37a', bits: '#fbe0ae' } },
  { id: 'guo-06', category: 'guo', photo: 'images/products/guo-06.jpg', name: '荔枝春青', m: 70, l: 75, recommended: true,
    noZeroSugar: true,
    desc: '荔枝香氣濃郁迷人，內含青茶凍增添口感，不提供無糖。',
    art: { base: '#e895a8', base2: '#f7cdd8', bits: '#8fae4a' } },
  { id: 'guo-07', category: 'guo', photo: 'images/products/guo-07.jpg', name: '水梨春青', m: 70, l: 75, recommended: true,
    noZeroSugar: true,
    desc: '清甜多汁的水梨果香，襯著春青茶湯，喝起來輕盈爽口，不提供無糖。',
    art: { base: '#d3dd8a', base2: '#eef3c4' } },
  { id: 'guo-08', category: 'guo', photo: 'images/products/guo-08.jpg', name: '輕蘋香茶', m: 75, l: 80, recommended: true,
    noZeroSugar: true,
